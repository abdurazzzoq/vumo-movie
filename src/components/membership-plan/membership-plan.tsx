  ...
  return (
    <div className="mt-6 grid grid-cols-1 gap-x-4 border px-4 py-4 md:grid-cols-4 md:border-x-1 md:border-t md:border-b-0  md:pb-0">
        <div className="space-y-4 py-4">
            ...
            <button className="bg-gray-300 hover:bg-gray-200 tansition-all font-medium text-black py-2 whitespace-nowrap h-10 w-3/5 md:w-4/5 shadow-md text-sm ">Cancel Membership</button>
        </div>

        <div className="col-span-3">
              <div className="flex flex-col justify-between border-b border-white/10 py-4 md:flex-row">
                <div className="">
                  <p className="font-semibold">Email: info@sammi</p>
            ...
            <div className="flex flex-col justify-between pt-4 pb-4 md:flex-row md:pb-0">
              <div className="">
                <p>Your membership plan will end on March 12 2024</p>
              </div>
